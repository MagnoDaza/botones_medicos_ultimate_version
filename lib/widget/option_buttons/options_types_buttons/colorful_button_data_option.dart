...
class ColorfulButtonOption extends ButtonDataOptions {
  const ColorfulButtonOption(
  ...
  Widget build(BuildContext context) {
    ...
    if (buttonData == null || buttonData is! ColorfulButtonData) {
      // Mostrar un widget de error o una vista vacía si buttonData es nulo o no es del tipo correcto
      return const Center(
          child: Text(
              'Error: No hay datos disponibles para el botón colorido.'));
    }

    final ColorfulButtonData colorfulButtonData = buttonData;

    return Column(
      children: [
        CustomSwitchRow(
          initialValue: colorfulButtonData.isBold,
        ...
        CustomSwitchRow(
          initialValue: colorfulButtonData.isItalic,
          updateButtonAttribute: (bool newValue) {
            buttonModel.updateButton(
        ...
        CustomSwitchRow(
          initialValue: colorfulButtonData.isUnderline,
          updateButtonAttribute: (bool newValue) {
            buttonModel.updateButton(
        ...
        CustomSwitchRow(
          initialValue: colorfulButtonData.isBorder,
          updateButtonAttribute: (bool newValue) {
            buttonModel.updateButton(
